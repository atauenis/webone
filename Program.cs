...
namespace WebOne
{
    /* TODO list for v0.10
     * 
     * 1. [semi ok] Move to .NET Core.
     * 2. [in do] Fix "Сбой установки соединения из-за неожиданного формата пакета" on SSL
     ...
     * 7. Fix "cannot load <temp file name>, it is in use by another process"
     * 8. New syntax of patch rules [may be in 0.11.0]
     * 9. Cache and log (sniffer) for debugging purposes
     * 
    */
